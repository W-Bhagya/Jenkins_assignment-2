        ...
        stages {
            ...
            stage('Test') {
              ...
              stage('Deploy to tomcat server') {
                  ...
                  deploy adapters:[tomcat9(credentialsId:'tomcat_credential',path:'',url:'http://20.204.174.39:8080')],contextPath:'/pipeline',onFailure:false,war:'/var/lib/jenkins/workspace/pipeline_using_variable/target/java-hello-world.war'
                  }
